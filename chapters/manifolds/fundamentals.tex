...
\begin{ex}
	...
	S^n = \{x\in\R^{n+1}:\norm{x}=1\}.
	\]
	The $(n+1)$--dimensional topologically open disc, or $(n+1)$--disc, defined as a subset of $\R^{n+1}$, is
	\[
	D^{n+1} = \{x\in\R^{n+1}:\norm{x}< 1\}.
	\]
	...
	\]
	The space $\overline{D}^{n+1}$, the topological closure of $D^{n+1}$, is the closed $(n+1)$--disc.
	Both $D^{n+1}$ and $\overline{D}^{n+1}$ are $(n+1)$--manifolds, $\overline{D}^{n+1}$ with boundary the $n$--sphere, a closed $n$--manifold.
