...
\begin{defn}
	\label{defthm:collar}
	Let $M$ be an $n$--manifold and $X\subset \pd M$.
	A \emph{collar} of $X$ is a diffeomorphism $f: X\times \HH\to X_U$ such that $U_X$ is an open neighbourhood of $X$ in $M$, $f(x,0)=(x)$ for every $x\in X$, and $U_X$ is an $n$--submanifold of $M$.
