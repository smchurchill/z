...
\begin{defn}
	A manifold $M$ with handle decomposition that consists of exactly one of 0--hangle and $g$ 1--handles is called a \emph{handlebody} of \emph{genus} $g$.
	Let $U$ and $V$ be 3--dimensional handlebodies of genus $g$ and let $f:\pd U\to \pd V$ be an orientation reversing diffeomorphism.
	The adjunction $M=U\cup_f V$ is a \emph{Heegard splitting} of $M$ and the shared boundary $\pd U = \pd V$ is the \emph{Heegard surface} of the splitting.
\end{defn}

\begin{theorem}
	Every closed, orientable 3--manifold can be realized as a Heegard splitting.
\end{theorem}
