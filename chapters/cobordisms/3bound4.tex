...
\begin{definition}
	A \emph{stratified} $n$--manifold is a space that satisfies the definition of an $n$--manifold everywhere except for a
\end{definition}


\begin{lem}
	\label{lem:3bodydecomp}
	There is a decomposition of $M$ induced by $f$ into $(3,1)$--handlebodies of genus 0, 1, 2, and 3, and these handlebodies intersect one another only along annuli embedded in their boundaries.		
\end{lem}
