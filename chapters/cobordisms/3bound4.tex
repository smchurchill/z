...
Let $X_f$ be the image of $S(f)$, which itself consists entirely of fold curves, through $f$ and $Y_f$ the image of $M$ through $f$.
...
We decompose $X_f$ into arc crossings and arcs that connect crossings.
