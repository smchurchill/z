...
\begin{proof}
	...
	To investigate $f\inv(D_1)$ we have two cases.
	A disc $D_{1,k}$ in $D_1$ is bisected by an arc $\alpha$ of codimension 1 critical points, and that arc is the image of either a definite fold or an indefinite fold.
