...
\begin{proof}
	...
	By the same argument, a collection of annuli, one per face of $D_{0,k}$, project through $f$ over the 1--boundary of $D_{0,k}$ and their shared boundaries project over the 2--boundary of $D){0,k}$.
