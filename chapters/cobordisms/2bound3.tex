...
\begin{proof}
	...
	This leaves $M\cup\{\textrm{2--handles}\}$ with boundary consisting of $\Sigma\times\{-1\}$ plus a disjoint collection of 2--discs, annuli, and pants with 2--discs glued to their boundary components.	
\end{proof}
